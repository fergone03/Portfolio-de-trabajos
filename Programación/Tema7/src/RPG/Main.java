...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (jugador1.getDinero() > 0) {
            System.out.println("¿Quieres cambiar tu fuerza por 1 oro? (s/n/t)");
            ...
            while (true) {
                ...
                switch (eleccion) {
                    case 1:
                        ...
                        int fuerzactualjefe = calcularFuerzaEnemigo;// usa fuerzactualjefe para calcular quien gana
                        int soltarOro = orosoltado;
                        if (fuerzactualjefe <= nuevoValorFuerza) {
                            System.out.println("has ganado!.Obtienes"+ soltarOro + "oro");
                        }

                        // TODO: Aquí deberías calcular la fuerza del enemigo y lógica de combate
                        break;
                    case 2:
                        System.out.println("Opciones de compra:");
                        System.out.println("1. Calculadora - Puntos de ataque: 5 - Precio: 3");
                        System.out.println("2. HTML- Recupera 10 puntos de salud - Precio: 5");
                        System.out.println("3. CalculadoraPlus - Puntos de ataque: 7 - Precio: 7");
                        System.out.println("4. CalculadoraPlusPlus - Puntos de ataque: 20 - Precio: 12");
                        System.out.println("5. CalculadoraPlusPlusPlus - Puntos de ataque: 99 - Precio: 33");
                        ...
                        switch (opcionCompra) {
                            ...
                            case 2:
                                if (jugador1.getDinero() >= 2) {
                                    ...
                                    System.out.println("No tienes suficiente oro para estudiar en Medac. Esto es un privado");
                                }
                                break;
                            case 3:
                                if (jugador1.getDinero() >= 3) {
                            ...
                            case 4:
                                if (jugador1.getDinero() >= 3) {
                                    ...
                                    System.out.println("Has comprado una Calculadora+++++++2UltimateEdition. Tu nuevo ataque es: "
                                            + jugador1.getPuntosAtaque());
                                } else {
                                    System.out.println("No tienes suficiente oro para comprar una Calculadora+++++++2UltimateEdition.");
                                }
                                break;
                            case 5:
                                if (jugador1.getDinero() >= 3) {
                                    ...
                                    System.out.println("Has comprado una Calculadora+++++++2UltimateEdition2. Ahora es personal. Tu nuevo ataque es: "
                                            + jugador1.getPuntosAtaque());
                                } else {
                                    System.out.println("No tienes suficiente oro para comprar una Calculadora+++++++2UltimateEdition2. Ahora es personal.");
                                }
                                break;
                                          case 6:
                                if (jugador1.getDinero() >= 3) {
                                    jugador1.setDinero(jugador1.getDinero() - 3);
                                    jugador1.setPuntosAtaque(jugador1.getPuntosAtaque() + 99);
                                    System.out.println("Has comprado una Calculadora+++++++++++2UltimateEdition3. La rebelión de los arrays. Ahora es personal. Tu nuevo ataque es: "
                                            + jugador1.getPuntosAtaque());
                                } else {
                                    System.out.println("No tienes suficiente oro para comprar una Calculadora+++++++++++2UltimateEdition3. La rebelión de los arrays. Ahora es personal.");
                                }
                                break;
                            default:
